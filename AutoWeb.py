...
class WebsiteGenerator:
    def __init__(self, master):
        ...
        self.create_input_field(main_frame, "Icon link:", 3)
        ...
        self.add_section_button.grid(row=7, column=0, columnspan=2, pady=20)
        ...
        self.generate_button.grid(row=8, column=0, columnspan=2, pady=(0, 20))
    ...
    def create_dropdown(self, parent, label, options, row):
        ...
        setattr(self, f"{label.lower().replace(':', '')}_dropdown", dropdown)
